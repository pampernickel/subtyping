...
getURL('https://raw.githubusercontent.com/pampernickel/subtyping/master/scripts/routineFuncs.r', ssl.verifypeer = F) -> script
...
binarizeMarkers(df, sub.list$groups, sub.list$tenomic, markers, 0.85)
...
binarizeMarkers(df, sub.list.batch1$groups, colnames(sub.list.batch1$exprs), markers, 0.85)